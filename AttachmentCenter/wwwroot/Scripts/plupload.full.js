...
(function() {
    ...
    function k() { this.cancelBubble = true }
    ...
    var g = {
        ...
        typeOf: function(p) { return ({}).toString.call(p).match(/\s([a-z|A-Z]+)/)[1].toLowerCase() },
        extend: function(o) {
            g.each(arguments,
                function(p, q) {
                    if (q > 0) {
                        g.each(p, function(s, r) { o[r] = s })
                    }
                });
            return o
        },
        cleanName: function(o) {
            var p, q;
            q = [
                /[\300-\306]/g, "A", /[\340-\346]/g, "a", /\307/g, "C", /\347/g, "c", /[\310-\313]/g, "E",
                /[\350-\353]/g, "e", /[\314-\317]/g, "I", /[\354-\357]/g, "i", /\321/g, "N", /\361/g, "n",
                /[\322-\330]/g, "O", /[\362-\370]/g, "o", /[\331-\334]/g, "U", /[\371-\374]/g, "u"
            ];
        ...
        buildUrl: function(p, o) {
            var q = "";
            g.each(o, function(s, r) { q += (q ? "&" : "") + encodeURIComponent(r) + "=" + encodeURIComponent(s) });
            if (q) {
                p += (p.indexOf("?") > 0 ? "&" : "?") + q
            }
            return p
        ...
        getSize: function(o) { return { w: o.offsetWidth || o.clientWidth, h: o.offsetHeight || o.clientHeight } },
        ...
        xmlEncode: function(o) {
            return o ? ("" + o).replace(m, function(p) { return a[p] ? "&" + a[p] + ";" : p }) : o
        },
        toArray: function(q) {
            var p, o = [];
        ...
        addI18n: function(o) { return g.extend(n, o) },
        translate: function(o) { return n[o] || o },
        ...
        removeClass: function(q, p) {
            ...
            q.className = q.className.replace(o, function(s, r, t) { return r === " " && t === " " ? " " : "" })
        },
        ...
        removeAllEvents: function(p) {
            ...
            g.each(d[p[e]], function(r, q) { g.removeEvent(p, q, o) })
        }
    };
    g.Uploader = function(s) {
        ...
        function t(rspFiles) {
            ...
            if (this.state == g.STARTED) {
                ...
                if (y == u.length) {
                    this.stop();
                    this.trigger("UploadComplete", u, rspFiles)
                }
            }
        }
        ...
        g.extend(this,
            {
                ...
                init: function() {
                    ...
                    if (typeof (s.preinit) == "function") {
                        ...
                        g.each(s.preinit, function(E, D) { B.bind(D, E) })
                    }
                        ...
                        function(D, G) {
                            ...
                            for (F = 0; F < G.length; F++) {
                                ...
                                if (E.size !== b && E.size > s.max_file_size) {
                                    D.trigger("Error",
                                        { code: g.FILE_SIZE_ERROR, message: g.translate("File size error."), file: E });
                                    continue
                                }
                                u.push(E);
                                I++
                    ...
                    B.bind("Error",
                        function(D, E) {
                            if (E.file) {
                                ...
                                o();
                                if (D.state == g.STARTED) {
                                    c(function() { t.call(B) }, 1)
                                }
                            }
                        });
                    B.bind("FileUploaded",
                        function(D, E,RspFiles) {
                            E.status = g.DONE;
                            E.loaded = E.size;
                            D.trigger("UploadProgress", E);
                            c(function () { t.call(B, RspFiles) }, 1)
                        });
                    if (s.runtimes) {
                        y = [];
                    ...
                    if (typeof (s.init) == "function") {
                        ...
                        g.each(s.init, function(E, D) { B.bind(D, E) })
                    }
                },
                ...
                hasEventListener: function(w) { return !!p[w.toLowerCase()] },
                bind: function(w, y, x) {
                    var z;
                    w = w.toLowerCase();
                    z = p[w] || [];
                ...
                unbindAll: function() {
                    var w = this;
                    g.each(p, function(y, x) { w.unbind(x) })
                },
                destroy: function() {
                    this.stop();
    ...
    g.QueueProgress = function() {
        ...
        o.percent = 0;
        o.bytesPerSec = 0;
        o.reset = function() { o.size = o.loaded = o.uploaded = o.failed = o.queued = o.percent = o.bytesPerSec = 0 }
    };
    g.runtimes = {};
    window.plupload = g
})();
            ...
            init: function(l, n) {
                ...
                l.bind("PostInit",
                    function() {
                        ...
                        c.addEvent(b.getElementById(p.browse_button),
                            "click",
                            function(u) {
                                var t = [], r, q, s;
                                u.preventDefault();
                        ...
                        function p() {
                            ...
                            function A(E) {
                                ...
                                if (y) {
                                    ...
                                    H = c.mimeTypes[r.name.replace(/^.+\.([^.]+)/, "$1").toLowerCase()] ||
                            ...
                            c.each(u.settings.headers, function(E, D) { h.setRequestHeader(D, E) });
                ...
                l.bind("DisableBrowse", function(o, p) { g = p });
                l.bind("Destroy",
                    function(o) {
    ...
    d.silverlight = {
        trigger: function(n, k) {
            ...
            if (m) {
                ...
                j[0] = "Silverlight:" + k;
                setTimeout(function() { m.trigger.apply(m, j) }, 0)
            }
        }
    };
            ...
            init: function(p, q) {
                ...
                p.bind("Silverlight:Init",
                    function() {
                        ...
                        h[p.id] = true;
                        p.bind("Silverlight:StartSelectFiles", function(t) { r = [] });
                            ...
                            function(t, v) {
                                ...
                                j().UploadFile(s[v.id],
                                    ...
                                    c({
                                        ...
                                        mime: d.mimeTypes[v.name.replace(/^.+\.([^.]+)/, "$1").toLowerCase()] ||
                                            "application/octet-stream",
                        ...
                        p.bind("Silverlight:MouseLeftButtonDown",
                            function(t) {
                                ...
                                if (u && v) {
                                    d.addClass(u, v);
                                    d.addEvent(b.body, "mouseup", function() { d.removeClass(u, v) })
                                }
                            });
                        ...
                        p.bind("DisableBrowse", function(t, u) { j().DisableBrowse(u) });
                        p.bind("Destroy",
                            function(t) {
                                var u;
    ...
    d.runtimes.Flash = d.addRuntime("flash",
        {
            ...
            init: function(n, p) {
                ...
                function o() { return b.getElementById(n.id + "_flash") }
                ...
                n.bind("Flash:Init",
                    function() {
                        ...
                        n.bind("CancelUpload", function() { o().cancelUpload() });
                        ...
                        n.bind("Flash:StageEvent:mouseDown",
                            function(t) {
                                ...
                                if (u && v) {
                                    d.addClass(u, v);
                                    d.addEvent(b.body, "mouseup", function() { d.removeClass(u, v) }, t.id)
                                }
                            });
                        ...
                        n.bind("Flash:ExifData", function(t, u) { n.trigger("ExifData", n.getFile(s[u.id]), u.data) });
                        n.bind("Flash:GpsData", function(t, u) { n.trigger("GpsData", n.getFile(s[u.id]), u.data) });
                        n.bind("QueueChanged", function(t) { n.refresh() });
                        n.bind("FilesRemoved",
                            function(t, v) {
                                var u;
                                for (u = 0; u < v.length; u++) {
                        ...
                        n.bind("StateChanged", function(t) { n.refresh() });
                        n.bind("Refresh",
                            function(t) {
                                var u, v, w;
                                o().setFileFilters(n.settings.filters, n.settings.multi_selection);
                        ...
                        n.bind("DisableBrowse", function(t, u) { o().disableBrowse(u) });
                        p({ success: true })
                    })
            }
        })
    ...
    a.runtimes.BrowserPlus = a.addRuntime("browserplus",
        {
            ...
            init: function(g, j) {
                ...
                function b() {
                    ...
                    g.bind("PostInit",
                        function() {
                            ...
                            function r(t, s) {
                                e.DragAndDrop.AddDropTarget({ id: t },
                                    function(u) {
                            ...
                            a.addEvent(document.getElementById(d.browse_button),
                                ...
                                function(y) {
                                    ...
                                    e.FileBrowse.OpenBrowseDialog({ mimeTypes: s },
                                        function(z) {
                                            if (z.success) {
                                                f(z.value)
                                            }
                    ...
                    g.bind("CancelUpload", function() { e.Uploader.cancel({}, function() {}) });
                    g.bind("DisableBrowse", function(l, m) { k = m });
                    g.bind("UploadFile",
                        function(o, l) {
                                ...
                                e.Uploader.upload({
                                    ...
                                    function(y) {
                                        ...
                                        if (y.success) {
                                            ...
                                            if (m) {
                                                o.trigger("ChunkUploaded",
                                                    l,
                                                    { chunk: u, chunks: w, response: y.value.body, status: x })
                                            }
                                            if (q.length > 0) {
                                                s(++u, w)
                                            } else {
                            ...
                            function r(u) {
                                l.size = u.size;
                                if (m) {
                                    e.FileAccess.chunk({ file: u, chunkSize: m },
                                        function(x) {
                                            if (x.success) {
                ...
                if (e) {
                    e.init(function(l) {
                        var k = [
                            { service: "Uploader", version: "3" }, { service: "DragAndDrop", version: "1" },
            ...
            getFeatures: function() {
                ...
                return {
                    ...
                    cantSendBlobInFormData: !!(
                        j.ua.gecko && h.FormData && h.FileReader && !FileReader.prototype.readAsArrayBuffer),
                    progress: r,
                    chunks: n,
                ...
                p.bind("Init",
                    function(w) {
                        ...
                        if (F) {
                            ...
                            if (z) {
                                j.addEvent(x, "mouseover", function() { j.addClass(F, z) }, w.id);
                                j.addEvent(x, "mouseout", function() { j.removeClass(F, z) }, w.id)
                            }
                            if (A) {
                                j.addEvent(x, "mousedown", function() { j.addClass(F, A) }, w.id);
                                j.addEvent(k.body, "mouseup", function() { j.removeClass(F, A) }, w.id)
                            }
                            if (w.features.triggerDialog) {
                                j.addEvent(F,
                                    "click",
                ...
                p.bind("PostInit",
                    function() {
                        ...
                        if (s) {
                            ...
                            j.addEvent(s, "dragover", function(t) { t.preventDefault() }, p.id);
                            j.addEvent(s,
                                "drop",
                                function(u) {
                    ...
                    function(s, u) {
                            ...
                            function B() {
                                ...
                                function G(V) {
                                    ...
                                    q.onreadystatechange = function() {
                                        ...
                                        if (q.readyState == 4 && s.state !== j.STOPPED) {
                                            ...
                                            if (W >= 400) {
                                                ...
                                                if (!K || ++D >= K) {
                                                    u.status = j.DONE;
                                                    s.trigger("FileUploaded",
                                                        u,
                                                        { response: q.responseText, status: W })
                                                } else {
                                                    B()
                                                }
                                            }
                                    ...
                                    if (s.settings.multipart && n.multipart) {
                                        ...
                                        q.open("post", E, true);
                                        j.each(s.settings.headers, function(X, W) { q.setRequestHeader(W, X) });
                                        if (typeof (V) !== "string" && !!h.FormData) {
                                            O = new FormData();
                                            j.each(j.extend(L, s.settings.multipart_params),
                                                function(X, W) { O.append(W, X) });
                                        ...
                                        if (typeof (V) === "string") {
                                            ...
                                            F = j.mimeTypes[u.name.replace(/^.+\.([^.]+)/, "$1").toLowerCase()] ||
                                                "application/octet-stream";
                                            R += P +
                                                N +
                                                U +
                        ...
                        if (n.jpgresize && s.settings.resize && /\.(png|jpg|jpeg)$/i.test(u.name)) {
                            d.call(s,
                                u,
                                s.settings.resize,
                                /\.png$/i.test(u.name) ? "image/png" : "image/jpeg",
                                function(z) {
                                    if (z.success) {
...
(function(d, a, b, c) {
    function e(f) { return a.getElementById(f) }
                    ...
                    function(p) {
                        ...
                        function v() {
                            ...
                            if (p.features.triggerDialog && B) {
                                b.addEvent(e(p.settings.browse_button),
                                    "click",
                                    function(D) {
                                        if (!A.disabled) {
                                            A.click()
                            ...
                            b.extend(A.style,
                                { width: "100%", height: "100%", opacity: 0, fontSize: "99px", cursor: "pointer" });
                        ...
                        p.bind("UploadFile",
                            function(y, B) {
                                ...
                                b.each(b.extend({ name: B.target_name || B.name }, y.settings.multipart_params),
                                    function(F, D) {
                        ...
                        p.bind("FileUploaded", function(y) { y.refresh() });
                        p.bind("StateChanged",
                            function(y) {
                        ...
                        p.bind("Refresh",
                            function(A) {
                                ...
                                if (G) {
                                    ...
                                    if (C) {
                                        b.addEvent(B, "mouseover", function() { b.addClass(G, C) }, A.id);
                                        b.addEvent(B, "mouseout", function() { b.removeClass(G, C) }, A.id)
                                    }
                                    if (D) {
                                        b.addEvent(B, "mousedown", function() { b.addClass(G, D) }, A.id);
                                        b.addEvent(a.body, "mouseup", function() { b.removeClass(G, D) }, A.id)
                                    }
                                }
                            });
                        f.bind("FilesRemoved",
